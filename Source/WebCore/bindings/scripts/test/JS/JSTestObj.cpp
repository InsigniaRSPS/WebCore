...
bool JSTestObjOwner::isReachableFromOpaqueRoots(JSC::JSCHandle<JSC::Unknown> handle, void*, SlotVisitor& visitor, const char** reason)
{
    UNUSED_PARAM(handle);
...
void JSTestObjOwner::finalize(JSC::JSCHandle<JSC::Unknown> handle, void* context)
{
